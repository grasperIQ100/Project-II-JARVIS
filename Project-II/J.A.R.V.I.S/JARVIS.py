...
engine.setProperty('voice',voices[0].id) #int '0' for (male) voice index '1' for (female) voice
...
class MainThread(QThread):
    ...
    def brows(self,command):
        ...
        if 'google' in command:
            ...
            S = self.take_Command()#taking command for what to search in edge
            webbrowser.open(f"{S}")
        elif 'edge' in command:
            self.talk('opening your Miscrosoft edge')
            os.startfile('C:\\Users\\Omkar\\OneDrive\\Desktop\\Microsoft Edge.lnk')#path for your edge browser application
        else :
            self.No_result_found()
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\ironman1.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\ringJar.gif")
        self.ui.label_3.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\circle.gif")
        self.ui.label_4.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\lines1.gif")
        self.ui.label_7.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\ironman3.gif")
        self.ui.label_8.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\circle.gif")
        self.ui.label_9.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\powersource.gif")
        self.ui.label_12.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\powersource.gif")
        self.ui.label_13.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"C:\Users\Omkar\OneDrive\Desktop\Project-II\J.A.R.V.I.S\UI\ironman3_flipped.gif")
        self.ui.label_16.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie(rf"")
